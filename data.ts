...
Through Unseen Exposures, I explored how art, data, and AI can meet in a space that educates without preaching, and how interaction can become a form of questioning.`,
  ...
  },
  {
    ...
    outcomeImages: [
      ...
      `${ROBOTIC_BIOPRINTING_IMG}outcome-geometry-catalogue-final.jpg`,
    ...
    concept: "The concept combined two research threads: topology optimization as a form-finding tool, using engineering load analysis to remove material where it isn't structurally needed, and non-planar robotic printing as the fabrication method able to follow the resulting organic, undercut-heavy geometry. Cork powder recycled from wine stoppers was chosen as the print material, mixed into a paste that could hold its own weight while curing. We ran the topology optimization twice, first exploring four rough leg/support configurations, then refining four more balanced variants, before selecting a single-leg, single-support geometry as the final stool design because it minimized material and support points while keeping deformation low at the point where legs merge into the seat.",
    process: [
      "Topology Optimization (ntop): We ran structural simulations on a loaded volume to let the software remove non-load-bearing material, producing a first catalogue of 4 geometries (varying legs and supports) and then a refined catalogue of 4 more, before selecting the final single-leg design.",
      "Material Formulation: Starting from a constant base of cork, bicarbonate and water, we ran 4 test batches scaling the gelatine/xanthan/pectin ratio by +5%, +10%, +15% and +20% to find a mix that extruded cleanly and held its own weight without slumping.",
      "Digital Toolpathing (Rhino + Grasshopper): The chosen geometry was flipped for printability, sliced into horizontal contours every 5mm (243 curves), and split into a base-support file and a body file so the robot controller could load it without exceeding its code-line limit.",
      "Robot Simulation & Printing: The toolpath was simulated on a 3D model of the ABB IRB 6700 in Rhino before sending it to the robot, which printed with a WASP pump extruder while an Arduino regulated pump pressure (15-50) and extruder motor speed (300-5,000) in sync with the robot's motion.",
      "Print Iterations: Early prints failed from lack of compressive strength and premature collapse, so we added infill, used temporary shoring during set time, and printed in segments to let lower layers cure before adding height, later replacing printed infill with loose ground cork and re-optimizing contour angles.",
      "Angle & Deformation Analysis: We ran an inclination analysis across 8 orientations of the design, reading which faces exceeded a safe overhang angle, and selected a final orientation that minimized deformation in the legs and merging areas, printing the piece upside down to counteract sagging at the seat."
    ],
    outcome: "The final stool printed successfully in cork paste, holding a form up to 45cm tall with overhangs beyond 30 degrees, something a standard flat-layer printer could not have built without extensive supports. A full base costs an estimated €237.72 to produce (about €100 in material, €137 in robot and labor time) at roughly 4.8kg and 130 minutes per piece. We also produced renders exploring how the same non-planar, cork-paste technique could scale up into architectural panels, cladding and furniture.",
    reflection: "This workshop was my introduction to robotic fabrication, and it reframed 3D printing for me as a spatial, six-degrees-of-freedom problem rather than a flat, layer-by-layer one. Working with a live biomaterial that could fail mid-print (collapsing, cracking, drying unevenly) taught me to treat fabrication as an iterative dialogue between the design file and the physical robot, not a one-way export, and to read every failed print as data for the next one.",
    collaborators: "Aayushi Vasnik, Vasileios Mavromitros, Clara Edith Carmona Hernández, Lauren Deming, Josh Oates and Jorge Muñoz (IAAC Master in Robotics & Advanced Construction); faculty Ricardo Mayor, Sheikh Rizvi Riaz and Nestor Beguin"
  },
  {
    id: "tania-pilot",
    title: "TÀNIA Pilot",
  ...
  },
  {
    ...
    // imgur's "h" thumbnail suffix serves a pre-resized (~1024px) version instead of the
    // full-resolution original, which is what was making this project's gallery slow to load.
    image: "https://i.imgur.com/XiPjkwQh.jpeg",
    externalLink: "https://incapto.com/",
    contextImage: "https://i.imgur.com/XRpZwgFh.jpeg",
    images: [
      "https://i.imgur.com/AbS7mF2h.jpeg",
      "https://i.imgur.com/zv69Eshh.jpeg",
      "https://i.imgur.com/iEjkPHvh.jpeg",
      "https://i.imgur.com/f1Bsdrih.jpeg",
      "https://i.imgur.com/PfIXVFVh.jpeg",
    ],
    processImages: [],
    outcomeImages: [
      "https://i.imgur.com/3n3lfpjh.jpeg",
      "https://i.imgur.com/E5rBDuFh.jpeg",
      "https://i.imgur.com/q5ZpNZqh.jpeg",
      "https://i.imgur.com/lIRwOuIh.jpeg",
      "https://i.imgur.com/n4IRMHKh.jpeg",
      "https://i.imgur.com/sq8OGV9h.jpeg",
      "https://i.imgur.com/Na71pILh.jpeg",
      "https://i.imgur.com/jy8ZZHkh.jpeg",
      "https://i.imgur.com/uTOACEOh.jpeg",
    ],
    reflectionImage: "https://i.imgur.com/XiPjkwQh.jpeg",
